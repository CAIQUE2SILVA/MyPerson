    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h4 className="text-xl font-bold mb-4">My Person</h4>
            <p className="text-gray-400">
              Sua loja de perfumes premium. Qualidade e elegância em cada fragrância.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link href="/frete" className="hover:text-white">Frete e Entrega</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 My Person. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
